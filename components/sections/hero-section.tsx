        ...
        >
            <div className="flex flex-col justify-center space-y-8">
                ...
                <motion.p variants={fadeUp} className="text-muted-foreground mx-auto max-w-2xl text-center text-lg md:text-xl lg:text-left">
                    ...
                    modern web apps, and smooth user experiences using{' '}
                    <span className="font-semibold text-lime-700 dark:text-lime-500">Laravel + React</span>.
                </motion.p>
                ...
                <motion.div variants={fadeUp} className="flex flex-wrap justify-center gap-4 lg:justify-start">
                    ...
                    {[
                        ...
                        <Button
                            ...
                            asChild
                            variant="secondary"
                            className="bg-background/30 rounded-full p-5 transition hover:scale-110 hover:bg-lime-500/20 hover:text-lime-700 dark:hover:text-lime-500"
                        >
